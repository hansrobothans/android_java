...
import com.example.learnandroid.adapter.NewsAdapter2;
import com.example.learnandroid.entity.News;

import java.util.ArrayList;
import java.util.List;

public class p25_ListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p25_listview_layout);
        mContext = this;
